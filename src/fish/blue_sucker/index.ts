...
export const blue_sucker: Fish = {
  ...
  habitat: ['Ohio creeks and small rivers', 'Ohio River and large tributaries', 'Large rivers with swift current over rocky bottoms', 'Ohio River', 'clear streams and rivers'],
